	...
	theme: {
		...
		extend: {
			colors: {
				...
				safety: {
					sage: 'hsl(var(--safety-sage))',
					sky: 'hsl(var(--safety-sky))'
				},
				booking: {
					blue: 'hsl(var(--primary))',
					yellow: 'hsl(var(--accent))',
					lightBlue: 'hsl(var(--safety-sky))',
					darkBlue: 'hsl(var(--secondary))',
					green: 'hsl(var(--safety-sage))'
				}
			},
			borderRadius: {
				lg: 'var(--radius)',
			...
			keyframes: {
				...
				'glow-pulse': {
					...
					'50%': { boxShadow: '0 0 25px hsl(var(--primary) / 0.8), 0 0 40px hsl(var(--primary-glow) / 0.6)' }
				},
				'slide-in-left': {
